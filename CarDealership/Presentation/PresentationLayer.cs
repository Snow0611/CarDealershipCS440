...
{
    public class PresentationLayer : Controller
    {
        ...
        public PresentationLayer(CarFunctions carFunctions, StaffFunctions staffFunctions)
        {
        ...
        public ActionResult CustomerInventory(List<Car> cars)
        {
